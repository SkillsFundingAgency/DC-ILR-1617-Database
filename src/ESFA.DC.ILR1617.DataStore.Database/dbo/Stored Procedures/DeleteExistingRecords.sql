...
BEGIN 
	...
	DELETE FROM [Invalid].[LearnerContact] WHERE UKPRN = @ukprn
	...
	DELETE FROM [Invalid].[PostAdd] WHERE UKPRN = @ukprn
	...
	DELETE FROM [Invalid].[TrailblazerApprenticeshipFinancialRecord] WHERE UKPRN = @ukprn
	...
	DELETE FROM [Rulebase].[TBLVAL_global] WHERE UKPRN = @ukprn
	DELETE FROM [Rulebase].[TBLVAL_ValidationError] WHERE UKPRN = @ukprn
	...
	DELETE FROM [Valid].[LearnerContact] WHERE UKPRN = @ukprn
	...
	DELETE FROM [Valid].[TrailblazerApprenticeshipFinancialRecord] WHERE UKPRN = @ukprn
END
